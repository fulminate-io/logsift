...
func TestIsGoStackFragment(t *testing.T) {
	tests := []struct {
		...
		{"postgresql log", logsift.Cluster{Template: "2026-02-27 18:47:01 UTC:10.0.1.100(59262):app_dbuser@app_db:[25084]:LOG:  could not receive data from client: Connection reset by peer", Examples: []string{"2026-02-27 18:47:01 UTC:10.0.1.100(59262):app_dbuser@app_db:[25084]:LOG:  could not receive data from client: Connection reset by peer"}}, false},
		{"logrus auth line", logsift.Cluster{Template: `time="2026-02-27T18:01:01Z" level=info msg="access granted" arn="arn:aws:iam::123456789012:role/Foo"`, Examples: []string{`time="2026-02-27T18:01:01Z" level=info msg="access granted" arn="arn:aws:iam::123456789012:role/Foo"`}}, false},
		...
		{"k8s info log", logsift.Cluster{Template: `I0227 18:05:27.012628      11 httplog.go:92] arn:aws:sts::123456789012:assumed-role/foo`, Examples: []string{`I0227 18:05:27.012628      11 httplog.go:92] arn:aws:sts::123456789012:assumed-role/foo`}}, false},
